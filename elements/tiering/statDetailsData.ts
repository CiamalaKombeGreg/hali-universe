...
export const statDetailsData: Record<string, StatModalData> = {
  ...
  "body-control": {
    ...
    table: {
      ...
      rows: [
        { name: "Inexistent", tier: "Below Average Human", value: "Variable" },
        { name: "Paralysis", tier: "Sub-Human", value: "Variable" },
        { name: "Coordination Impairment", tier: "Low Human", value: "Variable" },
        { name: "Balanced", tier: "Human", value: "Variable" },
        { name: "Coordination", tier: "High Human", value: "Variable" },
        { name: "Advanced Coordination", tier: "Low Superhuman", value: "Variable" },
        { name: "Proprioception", tier: "Superhuman", value: "Variable" },
        { name: "Near-Supremacy", tier: "High Superhuman", value: "Variable" },
  ...
  experience: {
    ...
    table: {
      ...
      rows: [
        ...
        { name: "Inexperienced", tier: "Human", value: "3.3" },
        { name: "Experienced", tier: "Human", value: "3.3" },
        { name: "Skilled", tier: "Human+", value: "3.4" },
        { name: "Expert", tier: "High Human", value: "3.6" },
        { name: "Masterful", tier: "High Human+", value: "3.7" },
        { name: "Virtuoso", tier: "Low Superhuman", value: "4" },
        { name: "Transcendent Experience", tier: "Superhuman → Structural", value: "5.3" },
        { name: "Near Universal Proficiency", tier: "Small / Observable Universe → Low Universal", value: "15" },
        { name: "Universal Proficiency", tier: "Universal", value: "15.3" },
        { name: "Limitless Proficiency", tier: "Complex Universal+", value: "16.4" },
        { name: "Infinite Proficiency", tier: "High Omniversal+", value: "24.7" },
        { name: "Absolute Proficiency", tier: "Outerversal", value: "99" },
        { name: "True Absolute Proficiency", tier: "Boundless", value: "999" },
      ],
    },
  },
  ...
  "emotional-control": {
    ...
    table: {
      ...
      rows: [
        { name: "Total Disorder", tier: "Sub-Human", value: "2.3" },
        { name: "Severe Disorder", tier: "Low Human", value: "3" },
        { name: "Disorder", tier: "Human", value: "3.3" },
        { name: "Basic Control", tier: "Human+", value: "3.4" },
        { name: "Self-Regulation", tier: "High Human", value: "3.6" },
        { name: "Measured", tier: "Low Superhuman", value: "4" },
        { name: "Composed", tier: "Superhuman", value: "4.3" },
        { name: "Imperturbable", tier: "Structural", value: "5.3" },
        { name: "Emotional Sovereignty", tier: "Universal", value: "15.3" },
        { name: "Transcendent Regulation", tier: "Outerversal / Boundless", value: "999" },
      ],
    },
  },
  ...
  "combat-skills": {
    ...
    table: {
      ...
      rows: [
        { name: "Total Incompetence", tier: "Inanimate", value: "1" },
        { name: "Incompetent", tier: "Sub-Human", value: "2.3" },
        { name: "Non-Combatant", tier: "Human", value: "3.3" },
        { name: "Combat Prowess", tier: "High Human", value: "3.6" },
        { name: "Skilled", tier: "Superhuman", value: "4.3" },
        { name: "Expert", tier: "Structural", value: "5.3" },
        { name: "Master Fighter", tier: "Regional", value: "6.3" },
        { name: "Genius / Gifted", tier: "Planetary", value: "7.3" },
        { name: "Super-Genius", tier: "Star", value: "8.3" },
        { name: "Transcendent Combatant", tier: "Planetary → Universal", value: "15" },
        { name: "Universal Skilled", tier: "Universal", value: "15.3" },
        { name: "Immeasurable Mastery", tier: "Above Complex Universal (4D+)", value: "24" },
        { name: "Absolute Combat Mastery", tier: "High Omniversal+ / Outerversal", value: "99" },
        { name: "Irrelevant", tier: "Boundless", value: "999" },
      ],
    },
  },
  ...
  "defensive-capabilities": {
    ...
    table: {
      ...
      rows: [
        { name: "Defenseless", tier: "Inanimate", value: "Variable" },
        { name: "Vulnerable", tier: "Sub-Human", value: "Variable" },
        { name: "Decent", tier: "Human", value: "Variable" },
        { name: "Trained Defense", tier: "Human+", value: "Variable" },
        { name: "Skilled Defense", tier: "High Human", value: "Variable" },
        { name: "Advanced Defense", tier: "Superhuman", value: "Variable" },
        { name: "Expert Defense", tier: "Structural", value: "Variable" },
        { name: "Master Defense", tier: "Regional", value: "Variable" },
        { name: "Defensive Genius", tier: "Planetary", value: "Variable" },
        { name: "Transcendent Defense", tier: "Planetary → Universal", value: "Variable" },
        { name: "Universal Defense", tier: "Universal", value: "Variable" },
        { name: "Complex Defense", tier: "Complex Universal", value: "Variable" },
        { name: "Multiversal Defense", tier: "Multiversal", value: "Variable" },
        { name: "Immeasurable Defense", tier: "Above Complex Multiversal (6D+)", value: "Variable" },
        { name: "Absolute Defense", tier: "Low Omniversal", value: "Variable" },
        { name: "Perfect Defense", tier: "Outerversal", value: "Variable" },
        { name: "Irrelevant", tier: "Boundless", value: "Variable" },
      ],
    },
  },
  ...
  "growth-speed": {
    ...
    table: {
      ...
      rows: [
        { name: "Stagnant", tier: "Inanimate", value: "1" },
        { name: "Low", tier: "Sub-Human", value: "2.3" },
        { name: "Basic", tier: "Human", value: "3.3" },
        { name: "High", tier: "Superhuman", value: "4.3" },
        { name: "Rapid", tier: "Structural", value: "5.3" },
        { name: "Superrapid", tier: "Regional", value: "6.3" },
        { name: "Hyperrapid", tier: "Planetary", value: "7.3" },
        { name: "Ultrarapid", tier: "Star", value: "8.3" },
        { name: "Cosmological", tier: "Small / Observable Universe", value: "14.3" },
        { name: "Near-Infinite", tier: "Low Universal", value: "15" },
        { name: "Infinite", tier: "Universal", value: "15.3" },
        { name: "Immeasurable", tier: "Above Complex Universal (4D+)", value: "24" },
        { name: "Instantaneous", tier: "Outerversal / Boundless", value: "999" },
      ],
    },
  },
  ...
  "power-mastery": {
    ...
    table: {
      ...
      rows: [
        { name: "Normie", tier: "Inanimate", value: "Variable" },
        { name: "Inept", tier: "Sub-Human", value: "Variable" },
        { name: "Initiate", tier: "Human", value: "Variable" },
        { name: "Practitioner", tier: "Human+", value: "Variable" },
        { name: "Skilled User", tier: "High Human", value: "Variable" },
        { name: "Expert User", tier: "Superhuman", value: "Variable" },
        { name: "Master User", tier: "Structural", value: "Variable" },
        { name: "Gifted / Genius User", tier: "Regional", value: "Variable" },
        { name: "Supreme User", tier: "Planetary", value: "Variable" },
        { name: "Transcendent Mastery", tier: "Planetary → Universal", value: "Variable" },
        { name: "Universal Mastery", tier: "Universal", value: "Variable" },
        { name: "Immeasurable Mastery", tier: "Above Complex Universal (4D+)", value: "Variable" },
        { name: "Absolute Mastery", tier: "Outerversal", value: "Variable" },
        { name: "Irrelevant", tier: "Boundless", value: "Variable" },
      ],
    },
  },
  ...
  "power-reserves": {
    ...
    table: {
      ...
      rows: [
        { name: "No Reserves", tier: "Inanimate", value: "1" },
        { name: "Reserve Sub-Human", tier: "Sub-Human", value: "2.3" },
        { name: "Reserve Human", tier: "Human", value: "3.3" },
        { name: "Reserve Superhuman", tier: "Superhuman", value: "4.3" },
        { name: "Reserve Structural", tier: "Structural", value: "5.3" },
        { name: "Reserve Regional", tier: "Regional", value: "6.3" },
        { name: "Reserve Planetary", tier: "Planetary", value: "7.3" },
        { name: "Reserve Stellar", tier: "Star", value: "8.3" },
        { name: "Reserve Cosmic", tier: "Galaxy Cluster", value: "12.3" },
        { name: "Reserve Universal", tier: "Universal", value: "15.3" },
        { name: "Reserve Infinite", tier: "Above Universal (4D+)", value: "24" },
        { name: "No Reserve / External", tier: "Variable source", value: "1" },
      ],
    },
  },
  ...
  "power-recovery": {
    ...
    table: {
      ...
      rows: [
        { name: "Irrecoverable", tier: "Irrecoverable / no recovery", value: "1" },
        { name: "Creeping", tier: "Creeping recovery", value: "2.3" },
        { name: "Sluggish", tier: "Sluggish", value: "3.3" },
        { name: "Very Slow", tier: "Very slow recovery", value: "4.3" },
        { name: "Slow", tier: "Slow recovery", value: "5.3" },
        { name: "Below Average", tier: "Below-average recovery", value: "6.3" },
        { name: "Average", tier: "Average recovery", value: "7.3" },
        { name: "Fast", tier: "Fast recovery", value: "8.3" },
        { name: "Superfast", tier: "Superfast recovery", value: "9.3" },
        { name: "Hyperfast", tier: "Hyperfast recovery", value: "10.3" },
        { name: "Ultrafast", tier: "Ultrafast recovery", value: "11.3" },
        { name: "Near-Instant", tier: "Small / Observable Universe", value: "14.3" },
        { name: "Instant", tier: "Universal", value: "15.3" },
        { name: "Immeasurable", tier: "Above Complex Universal (4D+)", value: "24" },
        { name: "Irrelevant", tier: "Outerversal / Boundless", value: "999" },
      ],
    },
  },
  ...
  "power-efficiency": {
    ...
    table: {
      ...
      rows: [
        { name: "Inefficient", tier: "Sub-Human", value: "Variable" },
        { name: "Wasteful", tier: "Low Human", value: "Variable" },
        { name: "Basic Efficiency", tier: "Human", value: "Variable" },
        { name: "Controlled", tier: "Human+", value: "Variable" },
        { name: "Efficient", tier: "High Human", value: "Variable" },
        { name: "Highly Efficient", tier: "Superhuman", value: "Variable" },
        { name: "Optimized", tier: "Structural", value: "Variable" },
        { name: "Peak Efficiency", tier: "Regional", value: "Variable" },
        { name: "Perfect Efficiency", tier: "Planetary", value: "Variable" },
        { name: "Transcendent Efficiency", tier: "Planetary → Universal", value: "Variable" },
        { name: "Universal Efficiency", tier: "Universal", value: "Variable" },
        { name: "Immeasurable Efficiency", tier: "Above Complex Universal (4D+)", value: "Variable" },
        { name: "Absolute Efficiency", tier: "Outerversal", value: "Variable" },
        { name: "Irrelevant", tier: "Boundless", value: "Variable" },
      ],
    },
  },
  ...
  "ontological-level": {
    ...
    table: {
      ...
      rows: [
        { name: "Non-Existence", tier: "Inanimate", value: "1" },
        { name: "Sub-Existential", tier: "Sub-Human", value: "2.3" },
        { name: "Physical (3D Existence)", tier: "Universal", value: "15.3" },
        { name: "Spatiotemporal (4D Existence)", tier: "Complex Universal", value: "16.3" },
        { name: "Multiversal (5D Existence)", tier: "Multiversal", value: "17.3" },
        { name: "Higher-Dimensional Entity", tier: "Above Complex Multiversal (6D+)", value: "24" },
        { name: "Conceptual Existence", tier: "Above Complex Multiversal (6D+)", value: "24" },
        { name: "Abstract / Fundamental Existence", tier: "High Omniversal+", value: "24.7" },
        { name: "Meta-Existential", tier: "High Omniversal+ / Outerversal", value: "99" },
        { name: "Narrative Existence", tier: "Outerversal", value: "99" },
        { name: "Trans-Narrative / Boundless", tier: "Boundless", value: "999" },
      ],
    },
  },
  ...
  versatility: {
    ...
    table: {
      ...
      rows: [
        { name: "Rigid", tier: "Sub-Human", value: "Variable" },
        { name: "Limited", tier: "Low Human", value: "Variable" },
        { name: "Basic", tier: "Human", value: "Variable" },
        { name: "Flexible", tier: "Human+", value: "Variable" },
        { name: "Adaptive", tier: "High Human", value: "Variable" },
        { name: "Highly Adaptive", tier: "Superhuman", value: "Variable" },
        { name: "Dynamic", tier: "Structural", value: "Variable" },
        { name: "Strategic", tier: "Regional", value: "Variable" },
        { name: "Genius Adaptation", tier: "Planetary", value: "Variable" },
        { name: "Universal Versatility", tier: "Universal", value: "Variable" },
        { name: "Immeasurable Versatility", tier: "Above Complex Universal (4D+)", value: "Variable" },
        { name: "Absolute Versatility", tier: "Outerversal", value: "Variable" },
        { name: "Irrelevant", tier: "Boundless", value: "Variable" },
      ],
    },
  },
  ...
  "activation-speed": {
    ...
    table: {
      ...
      rows: [
        { name: "Delayed", tier: "Sub-Human", value: "2.3" },
        { name: "Slow", tier: "Human", value: "3.3" },
        { name: "Moderate", tier: "Human+", value: "3.4" },
        { name: "Fast", tier: "Superhuman", value: "4.3" },
        { name: "Very Fast", tier: "Structural", value: "5.3" },
        { name: "Superfast", tier: "Regional", value: "6.3" },
        { name: "Hyperfast", tier: "Planetary", value: "7.3" },
        { name: "Ultrafast", tier: "Star", value: "8.3" },
        { name: "Near-Instant", tier: "Small / Observable Universe", value: "14.3" },
        { name: "Instant", tier: "Universal", value: "15.3" },
        { name: "Immeasurable", tier: "Above Complex Universal (4D+)", value: "24" },
        { name: "Irrelevant", tier: "Outerversal / Boundless", value: "999" },
  ...
  regeneration: {
    ...
    table: {
      ...
      rows: [
        { name: "Low-Low Regeneration", tier: "Sub-Human", value: "2.3" },
        { name: "Low-Mid Regeneration", tier: "Human", value: "3.3" },
        { name: "Low-High Regeneration", tier: "Superhuman", value: "4.3" },
        { name: "Mid-Low Regeneration", tier: "Structural", value: "5.3" },
        { name: "Mid-Mid Regeneration", tier: "Regional", value: "6.3" },
        { name: "Mid-High Regeneration", tier: "Planetary", value: "7.3" },
        { name: "High-Low Regeneration", tier: "Star", value: "8.3" },
        { name: "High-Mid Regeneration", tier: "Star System", value: "9.3" },
        { name: "High-High Regeneration", tier: "Galaxy", value: "11.3" },
        { name: "Godly-Low Regeneration", tier: "Universal", value: "15.3" },
        { name: "Godly-Mid Regeneration", tier: "Complex Universal", value: "16.3" },
        { name: "Godly-High Regeneration", tier: "Multiversal", value: "17.3" },
        { name: "Transcendent-Low Regeneration", tier: "Complex Multiversal", value: "18.3" },
        { name: "Transcendent-Mid Regeneration", tier: "Omniversal", value: "24.3" },
        { name: "Transcendent-High Regeneration", tier: "Outerversal", value: "99" },
        { name: "Irrelevant Regeneration", tier: "Boundless", value: "999" },
      ],
    },
  },
};