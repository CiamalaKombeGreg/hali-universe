...
export default function UniverseEntryCreatePage() {
  return (
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1650px] px-6 py-6 md:px-10">
          ...
          <section className="rounded-[34px] border border-white/10 bg-white/[0.03] p-6 backdrop-blur-sm">
            ...
            <h1 className="mt-4 text-4xl font-black text-white md:text-5xl">
              Create a new universe-level entry
            </h1>

            <p className="mt-4 max-w-4xl text-sm leading-7 text-white/65">
              Create universes, series collections, continuities, spinoffs,
              fanmade works, original creations, and crossovers from one adaptive form.
            </p>
          </section>

          <div className="mt-8">
            <UniverseEntryCreateForm />
          </div>
        </div>
      </div>
    </main>
